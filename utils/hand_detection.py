...
class HandDetection():
    ...
    def create_trackbars(self):
        ...
        cv2.createTrackbar('HueMax', 'Trackbars', 18, 179, empty)
        cv2.createTrackbar('SatMin', 'Trackbars', 19, 255, empty)
        cv2.createTrackbar('SatMax', 'Trackbars', 255, 255, empty)
        cv2.createTrackbar('ValMin', 'Trackbars', 89, 255, empty)
        cv2.createTrackbar('ValMax', 'Trackbars', 200, 255, empty)
